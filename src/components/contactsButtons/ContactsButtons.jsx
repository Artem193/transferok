...
export const ContactsButtons = () => {
  return (
    <div className="contactsButtons">
      <a
        href="https://wa.me/380978793288"
        className="contactsButtons__link"
        target="_blank"
      >
      ...
      <a
        href="viber://chat?number=380978793288"
        className="contactsButtons__link"
        target="_blank"
      >
      ...
      <a href="tel:+380978793288" className="contactsButtons__link">
